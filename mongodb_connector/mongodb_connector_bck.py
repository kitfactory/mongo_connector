        ...
        try:
            ...
            if parsed["statement"] == "select":
                ...
                if "primary_key" in columns:
                    column = parsed["primary_key"]["name"]
                    print("create index to ", column)
                    self.client[self.database][collection].create_index(column)
                self.client[self.database][collection].create_index("_id")
